...
var _XSSWiki = __webpack_require__(104);

var _XSSWiki2 = _interopRequireDefault(_XSSWiki);

var _Loading = __webpack_require__(42);

var _Loading2 = _interopRequireDefault(_Loading);

var _XSSPlayground = __webpack_require__(105);

var _XSSPlayground2 = _interopRequireDefault(_XSSPlayground);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function getMessages() {
      ...
      _axios2.default.get('/api/campaigns').then(function (res) {
        var campaigns = res.data;
        _this2.setState({ campaigns: campaigns });
      }).catch(function (err) {
        return console.log('error in getCampaigns in App.jsx: ', err);
      });
    }
  }, {
    key: 'render',
    value: function render() {
      return !this.state.campaigns ? _react2.default.createElement(_Loading2.default, null) : _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/XSSPlayground', component: _XSSPlayground2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/messages', component: _Messages2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/wiki', component: _XSSWiki2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _Messages2.default })
          ),
          _react2.default.createElement(
            'div',
            { className: 'campaign' },
            ...
            _react2.default.createElement(
              'h4',
              null,
              'Click a link below to navigate to that page: '
            ),
            _react2.default.createElement(
              'div',
...
var SendMessage = function (_React$Component) {
  ...
  _createClass(SendMessage, [{
    ...
    value: function sendMessage(e) {
      ...
      _axios2.default.post('/api/addMessage', {
        ...
        return console.log('error in sendMessage in SendMessage.jsx: ', err);
      });
    }
  }, {
    key: 'render',
...
var Messages = function (_React$Component) {
  ...
  _createClass(Messages, [{
    ...
    value: function getMessages() {
      ...
      _axios2.default.get('/api/getAllMessages').then(function (res) {
        var messages = res.data.results;
        _this2.setState({ messages: messages });
      }).catch(function (err) {
        return console.log('error in getMessages in Messages.jsx: ', err);
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return !this.state.messages ? _react2.default.createElement(_Loading2.default, null) : _react2.default.createElement(
        'div',
        null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'txn-header txn-row' },
              _react2.default.createElement(
                'div',
                { className: 'txn-data' },
                _react2.default.createElement(
                  'div',
                  { className: 'half-txn-data' },
                  _react2.default.createElement(
                    'div',
                    { className: 'half-txn-data' },
                    'Author'
            ...
            _react2.default.createElement(
              'div',
              null,
              !this.state.messages ? _react2.default.createElement(_Loading2.default, null) : this.state.messages.map(function (message) {
                console.log('this is the username: ', message.username);
                return _react2.default.createElement(
                  'div',
                  { className: 'txn-row', key: message.objectId },
                  _react2.default.createElement(
                    'div',
                    { className: 'txn-data' },
                    _react2.default.createElement(
...
var XSSWiki = function (_React$Component) {
  _inherits(XSSWiki, _React$Component);

  function XSSWiki(props) {
    _classCallCheck(this, XSSWiki);

    var _this = _possibleConstructorReturn(this, (XSSWiki.__proto__ || Object.getPrototypeOf(XSSWiki)).call(this, props));

    _this.state = {};
    _this.addToXSSWiki = _this.addToXSSWiki.bind(_this);
    return _this;
  }

  _createClass(XSSWiki, [{
    key: 'componentDidMount',
    value: function componentDidMount() {}
  }, {
    key: 'addToXSSWiki',
    value: function addToXSSWiki() {
      var _this2 = this;

      _axios2.default.post('/api/addMessage').then(function (res) {
        var messages = res.data;
        _this2.setState({ messages: messages });
      }).catch(function (err) {
        return console.log('error in sendMessage in SendMessage.jsx: ', err);
